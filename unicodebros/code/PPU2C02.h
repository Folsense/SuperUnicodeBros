...
public:
    //Can be a float, number of pixels drawn vertically is 240 / scanlinemod
    float scanlinemod = 4;
    //Must be an int, number of pixels drawn horizontally is 256 / cyclemod
    int cyclemod = 2;
    //Must be an int, number of frames drawn per second is 60 / drawmod
    int drawmod = 1;
